  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 bg-dark-bg border border-glass-border p-4 rounded-2xl shadow-[0_10px_40px_rgba(236,72,153,0.3)] z-50 flex items-center justify-between gap-4 animate-in slide-in-from-bottom-10">
      <div className="flex-1">
        <h3 className="text-foreground font-bold text-sm mb-1 flex items-center gap-2">
          Install App <span className="bg-primary text-[10px] px-1.5 py-0.5 rounded-full">RECOMMENDED</span>
        </h3>
        <p className="text-xs text-muted">Add to your home screen for a faster, full-screen experience and push notifications.</p>
      </div>
      <div className="flex items-center gap-2">
        ...
        <button onClick={handleDismiss} className="p-2 text-muted hover:text-foreground rounded-full bg-surface-elevated">
          <X size={16} />
        </button>
      </div>
    </div>
