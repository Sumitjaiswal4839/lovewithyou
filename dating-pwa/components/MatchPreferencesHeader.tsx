...
const DISTRICTS_DATA: Record<string, string[]> = {
  ...
  "Uttar Pradesh": [
    ...
    "Jhansi", "Jyotiba Phule Nagar", "Kannauj", "Kanpur Dehat", "Kanpur Nagar", "Kasganj", "Kaushambi", 
    "Kushnagar", "Lakhimpur Kheri", "Lalitpur", "Lucknow", "Maharajganj", "Mahoba", "Mainpuri", 
    "Mathura", "Mau", "Meerut", "Mirzapur", "Morabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", 
    "Raebareli", "Rampur", "Saharanpur", "Sambhal", "Sant Kabir Nagar", "Shahjahanpur", "Shamli", 
    "Shravasti", "Siddharthnagar", "Sitapur", "Sonbhadra", "Sultanpur", "Varanasi"
  ],
  "Madhya Pradesh": [
    "Agar Malwa", "Alirajpur", "Anuppur", "Ashoknagar", "Balahat", "Barwani", "Betul", "Bhind", 
    ...
    "Shivpuri", "Sidhi", "Singrauli", "Tikamgarh", "Ujjain", "Umaria", "Vidisha", "Mauganj", "Maihar", 
    "Pandhurna"
  ],
  "Jammu and Kashmir": [
  ...
  "Odisha": [
    "Angul", "Baudh", "Bhadrak", "Balangir", "Bargarh", "Balasore", "Cuttack", "Deogarh", 
    "Dhenkanal", "Ganjam", "Gajapati", "Jharsuguda", "Jajpur", "Jagatsinghpur", "Khordha", 
    "Keonjhar", "Kalahandi", "Kandhamal", "Koraput", "Kendrapara", "Mayurbhanj", "Malkangiri", 
    "Nabarangpur", "Nuapada", "Nayagarh", "Puri", "Rayagada", "Sambalpur", "Subarnapur", "Sundargarh"
  ],
  "Gujarat": [
    "Ahmedabad", "Amreli", "Anand", "Aravalli", "Banaskantha", "Bharuch", "Bhavnagar", "Botad", 
    "Chhota Udaipur", "Dahod", "Dang", "Devbhoomi Dwarka", "Gandhinagar", "Gir Somnath", "Jamnagar", 
    "Junagadh", "Kachchh", "Kheda", "Mahisagar", "Mehsana", "Morbi", "Narmada", "Navsari", 
    "Panchmahal", "Patan", "Porbandar", "Rajkot", "Sabaskantha", "Surat", "Surendranagar", "Tapi", 
    "Vadodara", "Valsad"
  ],
  "Manipur": [
  ...
  "Nagaland": [
    ...
    "Wokha", "Zunheboto", "Noklak", "Chümoukedima", "Niuland", "Tseminyu", "Shamator"
  ],
  "Andhra Pradesh": [
    "Ananthapuramu", "Anakapalli", "Alluri Sitharama Raju", "Bapatla", "Chittoor", "Dr. B.R. Ambedkar Konaseema", 
    "Eluru", "Guntur", "Kakinada", "Krishna", "Kurnool", "Nandyal", "NTR", "Palnadu", "Parvathipuram Manyam", 
    "Prakasam", "Sri Potti Sriramulu Nellore", "Sri Sathya Sai", "Srikakulam", "Tirupati", "Visakhapatnam", 
    "Vizianagaram", "West Godavari", "YSR (Kadapa)"
  ],
  "Arunachal Pradesh": [
    "Anjaw", "Bichom", "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Itanagar Capital Complex", 
    "Kamle", "Keyi Panyor", "Kra Daadi", "Kurung Kumey", "Lepa Rada", "Lohit", "Longding", "Lower Dibang Valley", 
    "Lower Siang", "Lower Subansiri", "Namsai", "Pakke-Kessang", "Papum Pare", "Shi Yomi", "Siang", "Tawang", 
  ...
  "Assam": [
    ...
    "Kamrup", "Kamrup Metropolitan", "Karbi Anglong", "Kokrajhar", "Lakhimpur", "Majuli", "Morigaon", "Nagaon", 
    "Nalbari", "Sivasagar", "Sonitpur", "South Salmara-Mankachar", "Sribhumi", "Tamulpur", "Tinsukia", "Udalguri", 
    "West Karbi Anglong"
  ],
  "Chhattisgarh": [
    "Balod", "Baloda Bazar-Bhatapara", "Balrampur-Ramanujganj", "Bastar", "Bemetara", "Bijapur", "Bilaspur", 
    "Dantewada", "Dhamtari", "Durg", "Gariaband", "Gaurela-Pendra-Marwahi", "Janjgir-Champa", "Jashpur", "Kanker", 
    "Kabirdham (Kawardha)", "Khairagarh-Chhuikhadan-Gandai", "Kondagaon", "Korba", "Koriya", "Mahasamund", 
  ...
  "Karnataka": [
    "Bagalkot", "Ballari", "Bangalore", "Belagavi", "Bengaluru Rural", "Bengaluru Urban", "Bidar", "Chamarajanagar", 
  ...
  "Maharashtra": [
    ...
    "Chandrapur", "Dhule", "Gadchiroli", "Gondia", "Hingoli", "Jalgaon", "Jalna", "Kolhapur", "Latur", "Mumbai", "Mumbai City", 
...
export default function MatchPreferencesHeader() {
  const [isOpen, setIsOpen] = useState(false);
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 relative z-50">
                  <SearchableSelect 
                    ...
                    onChange={(val) => updateMatchPreferences({ selectedState: val || null, selectedCity: null })}
                  ...
                  {currentDistricts ? (
                    <SearchableSelect 
                      ...
                      onChange={(val) => updateMatchPreferences({ selectedCity: val || null })}
